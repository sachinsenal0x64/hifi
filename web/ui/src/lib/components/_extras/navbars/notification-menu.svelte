...
>
	<Button
		size="icon"
		variant="ghost"
		class="relative cursor-pointer rounded-full p-4 text-zinc-100 shadow-none hover:bg-zinc-600 hover:text-zinc-100"
