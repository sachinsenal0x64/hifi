...
<Toggle
	...
	class={cn(
		'data-[state=off]:text-muted-foreground hover:data-[state=off]:text-accent-foreground data-[state=on]:text-muted-foreground hover:data-[state=on]:text-accent-foreground absolute right-0 top-1/2 size-9 min-w-0 -translate-y-1/2 p-0 hover:!bg-transparent data-[state=on]:bg-transparent',
		{
